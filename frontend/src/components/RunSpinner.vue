...
second hue: it is the seed the palette tunes for dark surfaces, so on light it
lands below the grey it would replace), and do not lift them to --ally-text-high.
-->
<template>
  <span
    class="run-bars"
