...
![Ally 界面截图](docs/img2.jpg)

![Ally 界面截图](docs/img3.jpg)
...
- 内置服务商/模型预设目录，添加模型时自动填充 API 格式、地址与上下文窗口
...
- 可跟随 Windows 或 macOS 系统代理，或手动配置 HTTP/HTTPS/SOCKS5 代理，并统一应用到模型、HTTP 工具、MCP、命令和后台服务
